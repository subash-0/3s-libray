...
const Hero = () => {
  ...
  const itemStyle ='text-white hover:bg-white/90 dark:bg-darkbg  hover:text-primary cursor-pointer w-full sm:w-fit dark:text-white  rounded-md shadow-md px-6 py-2 flex justify-center items-center flex-col';
  useEffect(() => {
  ...
  return (
    <div className="w-full">
      <div className="flex justify-center items-center gap-4 sm:gap-2 md:gap-6 lg:gap-10 flex-col sm:flex-row overflow-hidden">
